...
👉 [ghcr.io/FoveaParis/test3](https://ghcr.io/FoveaParis/test3) 🐳
...
#| eval: false
docker run -it ghcr.io/FoveaParis/test3:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/FoveaParis/test3:devel
```
...
#| eval: false
git clone git@github.com:FoveaParis/test3.git && cd FoveaParis/test3
